...
| Autophagy | These genes should be upregulated when this cell death pathway occurs. | 9 | BECN1, ATG5, ATG7, MAP1LC3B, ULK1, SQSTM1, ATG12, GABARAP, TFEB | Yamamoto et al (2023) | https://doi.org/10.1038/s41576-022-00562-w
| Apoptosis | These genes should be upregulated when this cell death pathway occurs. | 12 | CASP3, CASP7, CASP8, CASP9, BAX, BAK1, BOK, BCL2, BCL2L1, MCL1, APAF1, CYCS | Kiraz et al (2016) | https://doi.org/10.1007/s13277-016-5035-9
...
| Necroptosis | These genes should be upregulated when this cell death pathway occurs. | 3 | RIPK1, RIPK3, MLKL | Chen et al (2019) | doi: 10.3390/cells8121486
...
| Pyroptosis | These genes should be upregulated when this cell death pathway occurs. | 8 | AIM2, CASP1, CASP4, CASP5, GSDMD, GSDME, IL1B, NLRP3 | Wang et al (2022) | https://doi.org/10.3390/cancers14010237
